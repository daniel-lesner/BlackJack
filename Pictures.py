...
class Pictures:
    def __init__(self,screen):
        ...
        self.intro_play_x = int( self.screen_x/5  - self.intro_play.get_rect ()[2]/2 )
        self.intro_play_y = int( self.screen_center_y - self.intro_play.get_rect ()[3]/2 )
    ...
    def blitme(self,screen):
        ...
        if self.play_stage==True:
            if screen.playerscreen.points_cards==21:
            ...
            if screen.computerscreen.stage=="Dealer":
                if screen.computerscreen.points_cards<17:
                    screen.computerscreen.hit_card()
                if screen.computerscreen.points_cards>16:
